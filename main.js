...
var $author$project$Util$maybeOrElse = F2(
...
var $author$project$Util$dropHead = $elm$core$List$drop(1);
...
var $author$project$Main$settleFromNettedAmount = F2(
	function (positiveNetted, negativeNetted) {
		var _v0 = _Utils_Tuple2(
			$elm$core$List$head(positiveNetted),
			$elm$core$List$head(negativeNetted));
			...
			case 'CommitTransaction':
				var newTxnList = A2(
					...
					A2(
						$elm$core$Maybe$map,
						function (kt) {
							return A2($elm$core$List$cons, kt, model.txnList);
						},
						A2(
							$elm$core$Maybe$map,
							function (t) {
								return {data: t, key: model.runningTxnId};
							},
							model.parsedTxn)));
				return _Utils_update(
					model,
...
var $author$project$Page$Home$settlementTable = function (settlement) {
	var renderRow = function (kt) {
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromFloat(kt.amount))
						]))
				]));
	};
	var rows = A2($elm$core$List$map, renderRow, settlement);
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Payer (To Send)')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Payee (To Receive)')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
...
var $author$project$Page$Home$transactionsTable = function (transactions) {
	var renderRow = function (kt) {
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(kt.data.detail)
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(kt.data.payer)
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Model$RemoveTransaction(kt.key))
								]),
							_List_fromArray(
								[
									A2(
	...
	var rows = A2($elm$core$List$map, renderRow, transactions);
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
